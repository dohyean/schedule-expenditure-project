...
const PostBoard: React.FC = () => {
  ...
  function notice_add() {
    navigate("/test_add", {
      state: { value: 1, id: userInfo.id, title: "공지사항" },
    });
  }

  function complaint_add() {
    navigate("/test_add", {
      state: { value: 1, id: userInfo.id, title: "불만사항" },
    });
  }
          ...
          <div className="main_area">
            <div className="post_area">
              <div className="post_table">
                ...
                <table className="table">
                  ...
                  />
                  <button type="button" onClick={notice_add}>
                    작성
                  </button>
                </table>
                {modalOn && (
            ...
            <div className="complain_area">
              <div className="complain_table">
                ...
                <button type="button" onClick={complaint_add}>
                  작성
                </button>
                {modalOn && (
                  <PostModal
